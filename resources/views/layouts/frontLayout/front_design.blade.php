...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/frontend_css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/frontend_css/slick-theme.css')}}">
    ...
    <link rel="shortcut icon" href="{{asset('images/frontend_images/home/logo.png')}}">
...
<body>
    ...
    <script src="{{asset('js/frontend_js/slick.js')}}" type="text/javascript" charset="utf-8"></script>
